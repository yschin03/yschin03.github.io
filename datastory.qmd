...
<p style="color:#6200EA;">Overall, I can conclude that popularity is not signficantly affected by whether songs are explicit or not. </p>

## 3.0 How does different song attributes affect popularity? (Numeric variables)

Firstly, let's take a look at the distribution of different song attributes. The attributes that I will be focusing on are Speechiness, Tempo, Loudness, Acousticness and Valence.
