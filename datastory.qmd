...
## Songs Per Artist - Top 50 Artists
...
## Top 20 Songs Based On Popularity

Line graph features the top 20 songs from the dataset, arranged in descending order based on popularity level. Hover over each point to its individual popularity level out of 100.
...
p <- ggplot(df_top, aes(x = reorder(song, -popularity), y = popularity, group = 1)) +
  ...
  labs(title = "Top 20 Spotify Songs in Track List", x = "Song", y = "Popularity") +
