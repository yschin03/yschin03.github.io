...
*27.7% , or the minority of the songs in this dataset, are explicit.*
...
*2018 has the most number of explicit songs, at 49 songs.*
...
_The median popularity of explicit songs is 67 while that of non-explicit songs is 65. This shows that the explicit value of songs does contribute to its popularity slightly, as seen from the overall higher values found in explicit songs compared to non-explicit songs._
...
## 3.0 How does different song attributes affect popularity?

Firstly, let's take a look at the distribution of different song attributes.
