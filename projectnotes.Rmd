...
rsconnect::setAccountInfo(name='edwxgo-yin0shuen-chin', token='1E2DB8D66D68057A6A967920CD1031EC', secret='KqDM4lbsuF9akAcI4+djkTS3eGtZ7sThD0yyspQW')


notes:
first: clean data
> remove duplicate values; remove NA values
...
## Data visualisations:
## 1. total number of songs versus genre (histogram?)
  
```{r}
#App1
#shiny app following example 1
...
# Create line plot
ggplot(df_top, aes(x = song, y = popularity, color = artist)) +
  geom_line() +
  geom_point() +
  labs(title = "<b>Top 25 songs in Spotify", x = "Song", y = "Popularity") +
...
# Assuming the dataset is loaded in the dataframe 'df'
...
## 8. popularity versus explicit content (box plot)  
```{r setup, include=FALSE}
